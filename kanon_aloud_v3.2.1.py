...
# -*- coding: utf-8 -*-
"""
Kanon-Claude Aloud v3.2.1
Optimized for Claude Code CLI with background execution support
Volume: Normal 1.0, Thinking 0.5
Based on v3.2.0 with proper process management and graceful shutdown
v3.2.1: Background execution support, process management, signal handling
"""
...
def monitor_and_speak():
    ...
    logger.info("="*70)
    logger.info("Kanon-Claude Aloud v3.2.1")
...
def main():
    ...
    print("="*70)
    print("Kanon-Claude Aloud v3.2.1")
    print("Background execution optimized for Claude Code CLI")
    print("="*70)
