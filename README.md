...
## 最新バージョン: v4.0.0 (2026-03-30)

### 🎉 v4.0.0 最新版の特徴
- 🖥️ Claude Code Desktop完全対応
- 🔧 ツール実行を自然な日本語で読み上げ（「パイソンファイルを編集します」等）
- 🧠 英語の内部思考を自動で日本語に変換
- 📨 ユーザー入力の受信確認・許可通知の読み上げ
- 📖 100語以上の技術用語辞書による完全日本語化
- 🔇 音量の細分化（通常: 0.3、思考・ツール: 0.1）
...
- **v4.0.0 (2026-03-30)**: Claude Code Desktop対応・完全日本語ナレーション版
  - ツール実行・内部思考・ユーザー入力をすべて日本語で読み上げ
  - サブエージェントJSONL除外
  - 技術用語辞書100語以上
